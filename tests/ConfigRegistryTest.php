...
class ConfigRegistryTest extends TestCase {
	...
	public function test_error_config_data_can_be_fetched_as_a_verified_dto_object(): void {
	...
	public function test_error_faulty_config_data_fetch_with_dto_object_throws_type_error(): void {
		$this->expectException(BadEnvironmentException::class);
	...
	public function test_error_accessing_a_non_existing_key_will_throw_a_helpful_exception(): void {
		$this->expectException(BadEnvironmentException::class);
